...
(() => {
  ...
  const projectUrl = (project) => `/work/${project.id}/`;
    ...
    projects.forEach((project, index) => {
      ...
      link.innerHTML = `
        <span class="fish-crop" style="--source-y:${project.fish.sourceY};--source-height:${project.fish.sourceHeight}">
          <img src="/assets/images/fish-reference.png" alt="${escapeHtml(project.title)} fish">
        </span>
    ...
    project.slides.forEach((slide) => {
      ...
      const imageHtml = slide.image
        ...
        <figure class="project-photo">
          <img src="${escapeHtml(slide.image.src)}" alt="${escapeHtml(slide.image.alt)}" loading="lazy">
